...
plt.legend()
plt.savefig('./Homeworks/Hw2/imgs/cifar100_loss_plot_Alex_Dropout_x.png')
plt.show()
...
torch.save(model.state_dict(), './Homeworks/Hw2/models/cifar100_Alex_Dropout_x.pth')  # .pth is the recommended extension    